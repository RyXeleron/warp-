...
import os
import sys
ImportWarning ('requested module imports')
script_version = '4.0.0'
window_title   = f"WARP-PLUS-CLOUDFLARE By Ry (version {script_version})"
os.system('title ' + window_title if os.name == 'nt' else 'PS1="\[\e]0;' + window_title + '\a\]"; echo $PS1')
os.system('cls' if os.name == 'nt' else 'clear')

print ('THIS SCRIPT CODDED BY RY')
print ("[+] ABOUT SCRIPT:")
print ("[-] With this script, you can getting unlimited GB on Warp+. The Tools By Ry ")
print ("[-] This script is for Educational Purposes Only. I am not responsible for any misuse of this script.")
...
while True:
	os.system('cls' if os.name == 'nt' else 'clear')
	print("")
	print("                  WARP-PLUS-CLOUDFLARE (script)" + " By Ry")
	print("")
